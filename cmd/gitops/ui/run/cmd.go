...
func NewCommand() *cobra.Command {
	...
	cmd.Flags().StringVar(&options.NotificationControllerAddress, "notification-controller-address", "http://notification-controller.wego-system.svc.cluster.local./", "the address of the notification-controller running in the cluster")
